...
var myForm = function () {
  ...
  function getData() {
    ...
    var phone = viewForm.phone.value;
  ...
  function submit() {
    ...
    if (validationInfo.isValid) {
      ...
      return (0, _request2.default)().then(_response2.default);
    }
    if (!validationInfo.isValid) {
...
function requestToServer() {
  var form = _view2.default.domEls.form;
  var formAction = form.getAttribute('action');

  return fetch(formAction).then(function (res) {
    return res.json();
  });
}
...
},{"../view":14,"./fetchMap":3}],5:[function(require,module,exports){
'use strict';
