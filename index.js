...
var _email = require('./validate/email');

var _email2 = _interopRequireDefault(_email);

var _FIO = require('./validate/FIO');

var _FIO2 = _interopRequireDefault(_FIO);

var _phone = require('./validate/phone');

var _phone2 = _interopRequireDefault(_phone);

var _mergeErrors = require('./validate/mergeErrors');

var _mergeErrors2 = _interopRequireDefault(_mergeErrors);
...
var myForm = function () {
  var viewForm = _view2.default.domEls.formFields;

  function getData() {
    var fio = viewForm.fio.value;
    var email = viewForm.email.value;
    var phone = viewForm.phone.value.replace(/[+\-()]/gi, '');
  ...
  function validate() {
    ...
    var fioErrors = (0, _FIO2.default)(userData.fio);
    var emailErrors = (0, _email2.default)(userData.email);
    var phoneErrors = (0, _phone2.default)(userData.phone);

    errorFields = (0, _mergeErrors2.default)(fioErrors, emailErrors, phoneErrors);
  ...
  function setData(_ref) {
    ...
    var formatedPhone = _vanillaMasker2.default.toPattern(phone, '+9(999)999-99-99');
  ...
  function submit(evt) {
    ...
    var validationInfo = validate();

    _view2.default.domActions.resetForm();

    if (validationInfo.isValid) {
      _view2.default.domActions.disableBtn();
      (0, _request2.default)().then(_response2.default);
    }
    if (!validationInfo.isValid) {
      return _view2.default.domActions.borderError(validationInfo.errorFields);
    }
...
},{"./request":4,"./response":6,"./validate/FIO":9,"./validate/email":10,"./validate/mergeErrors":12,"./validate/phone":13,"./view":14,"vanilla-masker":311}],2:[function(require,module,exports){
'use strict';
...
var _MyForm = require('./MyForm');

var _MyForm2 = _interopRequireDefault(_MyForm);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var _myForm = _MyForm2.default;
window.MyForm = _myForm;

},{"./MyForm":1,"babel-polyfill":15,"whatwg-fetch":312}],3:[function(require,module,exports){
'use strict';
...
function requestWithErr() {
  return fetch('/js/mock_res/error.json').then(function (res) {
    return res.json();
  });
}

function requestWithProg() {
  return fetch('/js/mock_res/progress.json').then(function (res) {
    return res.json();
  });
}

function requestWithSucc() {
  return fetch('/js/mock_res/success.json').then(function (res) {
    return res.json();
  });
}

exports.requestWithErr = requestWithErr;
exports.requestWithProg = requestWithProg;
exports.requestWithSucc = requestWithSucc;
...
var _fetchMap = require('./fetchMap');

function requestToServer() {
  var reqVariations = [_fetchMap.requestWithErr, _fetchMap.requestWithSucc, _fetchMap.requestWithProg];
  var randomAction = reqVariations[Math.floor(Math.random() * reqVariations.length)];
...
},{"./fetchMap":3}],5:[function(require,module,exports){
'use strict';
...
function errorHandler(response) {
  var resultBlock = _view2.default.domEls.resultBlock;

  _view2.default.domActions.resetResultBlock();
...
var _progressHandler = require('./progressHandler');

var _progressHandler2 = _interopRequireDefault(_progressHandler);
...
function responseHandler(response) {
  ...
  switch (response.status) {
    case 'error':
      return (0, _errorHandler2.default)(response);
    case 'success':
      return (0, _successHandler2.default)();
    case 'progress':
      return (0, _progressHandler2.default)(response);
    default:
      return false;
  }
}
...
},{"../view":14,"./errorHandler":5,"./progressHandler":7,"./successHandler":8}],7:[function(require,module,exports){
'use strict';
...
function progressHandler(response) {
  ...
  setTimeout(function () {
    (0, _request2.default)().then(_2.default);
  }, response.timeout);

  return 'kek';
}

exports.default = progressHandler;

},{"../request":4,"../view":14,"./":6}],8:[function(require,module,exports){
'use strict';
...
},{"../view":14}],9:[function(require,module,exports){
'use strict';
...
function fioValidate(fio) {
  var errors = [];
  var fioLength = fio.split(' ').filter(function (str) {
    return str.length;
  }).length;
...
var _validationConfig = require('./validationConfig');

function emailValidate(email) {
  var errors = [];

  if (!_validationConfig.emailPattern.test(email)) {
    errors.push('email должен иметь вид example@yandex.ru');
    return errors;
  }

  var emailDomain = email.split('@')[1];
  var yaMail = _validationConfig.domains.some(function (domain) {
    return emailDomain === domain;
  });
  if (!yaMail) {
    errors.push('email \u0434\u043E\u043B\u0436\u0435\u043D \u0431\u044B\u0442\u044C \u0442\u043E\u043B\u044C\u043A\u043E \u0432 \u0434\u043E\u043C\u0435\u043D\u0430\u0445 ' + _validationConfig.domains.join(', '));
  }
...
},{"./validationConfig":11}],11:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
var domains = ['yandex.kz', 'ya.ru', 'yandex.ru', 'yandex.ua', 'yandex.by', 'yandex.com'];
...
function sumCheck(phone, max) {
  var commSum = phone.split('').reduce(function (prev, next) {
    var count = +prev + +next;
    return count;
  });
...
var view = function () {
  ...
  var resultBlock = document.getElementById('resultContainer');
  var formFields = {
    fio: fio,
    email: email,
    phone: phone
  ...
  (0, _vanillaMasker2.default)(phone).maskPattern('+9(999)999-99-99');

  form.addEventListener('submit', function (evt) {
    return _MyForm2.default.submit(evt);
  });
  ...
  var domActions = {
    ...
    resetResultBlock: resetResultBlock
  };
...
},{"./MyForm":1,"vanilla-masker":311}],15:[function(require,module,exports){
(function (global){
"use strict";
...
},{"core-js/fn/regexp/escape":16,"core-js/shim":309,"regenerator-runtime/runtime":310}],16:[function(require,module,exports){
